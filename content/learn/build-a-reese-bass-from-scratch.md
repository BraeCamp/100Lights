...
**Two voices, detuned small.** One sawtooth is just a bass note — the growl only exists once there are two of them slightly apart. In the poly synth, turn the oscillator's **Voices** up to 2 and set the **Spread** to about 9 cents. That's a deliberately conservative number and I'd argue it's the right starting point, because spread is the one control here where people immediately overdo it. Nine cents is barely audible as pitch and completely audible as motion. Push it to 30 and you get something thicker but blurrier. Push it past 50 and you don't have a Reese anymore, you have a chorus effect with a headache.
