...
// ── Drawable Tone-EQ curve ───────────────────────────────────────────────────
// Replaces the fiddly EQ knobs (which overflowed the strip): a small graph you
// draw on — drag a band's point up/down (like a vertical slider) to set its ±12 dB
// gain, double-click for flat. Bands sit at their real frequencies (log x-axis):
// sub 70 · bass 200 · mid 1k · treble 8k.
type EqBand = 'sub' | 'bass' | 'mid' | 'treble'
function EqCurve({ value, onChange, width = 66, height = 42 }: {
