...
const FEATURES: Feature[] = [
  ...
  { group: 'Recording', name: 'Record Quantization', helpIds: ['record-quantize'], modes: ['music'], hint: 'Press Record — "Quantize as played" sits in the record setup box. Or type "record quantization" in ⌘K.',
