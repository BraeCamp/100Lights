...
const TOOLS = [
  ...
  },
  {
    ...
    icon: Piano,
    title: 'Chord Teacher',
    hook: 'Progressions, every chord, and an identifier',
    blurb: 'Play the progressions behind a thousand songs, browse every chord on any root, or click notes to identify a chord. Transpose and download MIDI.',
