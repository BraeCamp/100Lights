...
export const metadata: Metadata = {
  title: 'Transcribe — Turn Audio Into MIDI Notes',
  ...
  alternates: { canonical: 'https://100lights.com/apps/transcribe' },
  openGraph: {
    title: 'Transcribe — 100Lights',
    description: 'Audio → MIDI. Upload or record a melody line and turn it into editable notes. Free, in your browser.',
    url: 'https://100lights.com/apps/transcribe',
    type: 'website',
    siteName: '100Lights',
  },
}
