...
// Every kit is a COMPLETE sampled set - all ten pads carry their own one-shot
// (generated by scripts/gen-drum-kits.mjs -> public/drum-kits/), so switching
// kits changes every sound, not a pad-tweak over a shared synth voice
// (Brae 2026-08-18). The synth pack + voices remain the FALLBACK for a hit
// that lands before its sample has decoded.
const sp = (kit: string, pitch: number, name: string, volume: number): DrumPadSettings => ({
  volume, pitch: 0, pan: 0, mute: false,
  sample: { id: `bk-${kit}-${pitch}`, name, data: `/drum-kits/${kit}/${pitch}.wav` },
})
export const DRUM_KITS: DrumKit[] = [
  { id: 'studio', name: 'Studio', desc: 'Clean, balanced acoustic kit',
    instrument: { type: 'drum', params: { pack: 'synth', pads: {
      36: sp('studio', 36, 'Kick', 1.0),
      38: sp('studio', 38, 'Snare', 0.95),
      39: sp('studio', 39, 'Clap', 0.9),
      41: sp('studio', 41, 'Low Tom', 0.85),
      42: sp('studio', 42, 'Hat', 0.6),
      45: sp('studio', 45, 'Mid Tom', 0.85),
      46: sp('studio', 46, 'Open Hat', 0.6),
      48: sp('studio', 48, 'High Tom', 0.85),
      49: sp('studio', 49, 'Crash', 0.65),
      51: sp('studio', 51, 'Rim', 0.8),
    } } },
    voices: { snare: 'acoustic', hat: 'normal' } },
  { id: 'boombap', name: 'Boom Bap', desc: 'Dusty hip-hop - fat snare, loose hats',
    instrument: { type: 'drum', params: { pack: 'synth', pads: {
      36: sp('boombap', 36, 'Kick', 1.0),
      38: sp('boombap', 38, 'Snare', 0.95),
      39: sp('boombap', 39, 'Clap', 0.9),
      41: sp('boombap', 41, 'Low Tom', 0.85),
      42: sp('boombap', 42, 'Hat', 0.6),
      45: sp('boombap', 45, 'Mid Tom', 0.85),
      46: sp('boombap', 46, 'Open Hat', 0.6),
      48: sp('boombap', 48, 'High Tom', 0.85),
      49: sp('boombap', 49, 'Crash', 0.65),
      51: sp('boombap', 51, 'Rim', 0.8),
    } } },
    voices: { snare: 'fat', hat: 'loose' } },
  { id: 'rock', name: 'Rock', desc: 'Big room - long toms, gated snare',
    instrument: { type: 'drum', params: { pack: 'synth', pads: {
      36: sp('rock', 36, 'Kick', 1.0),
      38: sp('rock', 38, 'Snare', 0.95),
      39: sp('rock', 39, 'Clap', 0.9),
      41: sp('rock', 41, 'Low Tom', 0.85),
      42: sp('rock', 42, 'Hat', 0.6),
      45: sp('rock', 45, 'Mid Tom', 0.85),
      46: sp('rock', 46, 'Open Hat', 0.6),
      48: sp('rock', 48, 'High Tom', 0.85),
      49: sp('rock', 49, 'Crash', 0.65),
      51: sp('rock', 51, 'Rim', 0.8),
    } } },
    voices: { snare: 'tight', hat: 'normal' } },
  { id: 'pop', name: 'Pop', desc: 'Crisp and tight, clap-forward sparkle',
    instrument: { type: 'drum', params: { pack: 'synth', pads: {
      36: sp('pop', 36, 'Kick', 1.0),
      38: sp('pop', 38, 'Snare', 0.95),
      39: sp('pop', 39, 'Clap', 0.9),
      41: sp('pop', 41, 'Low Tom', 0.85),
      42: sp('pop', 42, 'Hat', 0.6),
      45: sp('pop', 45, 'Mid Tom', 0.85),
      46: sp('pop', 46, 'Open Hat', 0.6),
      48: sp('pop', 48, 'High Tom', 0.85),
      49: sp('pop', 49, 'Crash', 0.65),
      51: sp('pop', 51, 'Rim', 0.8),
    } } },
    voices: { snare: 'acoustic', hat: 'tight' } },
  { id: 'house', name: 'House', desc: 'Four-on-the-floor - 909 claps + open hats',
    instrument: { type: 'drum', params: { pack: 'synth', pads: {
      36: sp('house', 36, 'Kick', 1.0),
      38: sp('house', 38, 'Snare', 0.95),
      39: sp('house', 39, 'Clap', 0.9),
      41: sp('house', 41, 'Low Tom', 0.85),
      42: sp('house', 42, 'Hat', 0.6),
      45: sp('house', 45, 'Mid Tom', 0.85),
      46: sp('house', 46, 'Open Hat', 0.6),
      48: sp('house', 48, 'High Tom', 0.85),
      49: sp('house', 49, 'Crash', 0.65),
      51: sp('house', 51, 'Rim', 0.8),
    } } },
    voices: { snare: 'tight', hat: 'tight' } },
  { id: 'lofi', name: 'Lo-Fi', desc: 'Soft, dark, laid-back and crushed',
    instrument: { type: 'drum', params: { pack: 'synth', pads: {
      36: sp('lofi', 36, 'Kick', 1.0),
      38: sp('lofi', 38, 'Snare', 0.95),
      39: sp('lofi', 39, 'Clap', 0.9),
      41: sp('lofi', 41, 'Low Tom', 0.85),
      42: sp('lofi', 42, 'Hat', 0.6),
      45: sp('lofi', 45, 'Mid Tom', 0.85),
      46: sp('lofi', 46, 'Open Hat', 0.6),
      48: sp('lofi', 48, 'High Tom', 0.85),
      49: sp('lofi', 49, 'Crash', 0.65),
      51: sp('lofi', 51, 'Rim', 0.8),
    } } },
    voices: { snare: 'fat', hat: 'loose' } },
  { id: 'trap808', name: '808 Trap', desc: 'Deep 808 sub kick, bright crack, ticky hats',
    instrument: { type: 'drum', params: { pack: '808', pads: {
      36: sp('trap808', 36, 'Kick', 1.0),
      38: sp('trap808', 38, 'Snare', 0.95),
      39: sp('trap808', 39, 'Clap', 0.9),
      41: sp('trap808', 41, 'Low Tom', 0.85),
      42: sp('trap808', 42, 'Hat', 0.6),
      45: sp('trap808', 45, 'Mid Tom', 0.85),
      46: sp('trap808', 46, 'Open Hat', 0.6),
      48: sp('trap808', 48, 'High Tom', 0.85),
      49: sp('trap808', 49, 'Crash', 0.65),
      51: sp('trap808', 51, 'Rim', 0.8),
    } } },
    voices: { snare: 'tight', hat: 'tight' } },
  { id: 'techno', name: 'Techno', desc: 'Hard, raw and minimal - clipped and industrial',
    instrument: { type: 'drum', params: { pack: '808', pads: {
      36: sp('techno', 36, 'Kick', 1.0),
      38: sp('techno', 38, 'Snare', 0.95),
      39: sp('techno', 39, 'Clap', 0.9),
      41: sp('techno', 41, 'Low Tom', 0.85),
      42: sp('techno', 42, 'Hat', 0.6),
      45: sp('techno', 45, 'Mid Tom', 0.85),
      46: sp('techno', 46, 'Open Hat', 0.6),
      48: sp('techno', 48, 'High Tom', 0.85),
      49: sp('techno', 49, 'Crash', 0.65),
      51: sp('techno', 51, 'Rim', 0.8),
    } } },
    voices: { snare: 'acoustic', hat: 'normal' } },
]
...
/** Which kit an instrument matches, for the picker. Sampled kits are identified
 *  by the kick pad's unique sample id; legacy synth-tweak kits fall back to the
 *  old pack + kick-tuning match. */
export function kitIdForInstrument(inst: TrackInstrument | undefined): string | null {
  ...
  const sid = p.pads?.[36]?.sample?.id
  for (const k of getKits()) {
    const kp = k.instrument.params as { pack?: string; pads?: Record<number, DrumPadSettings> }
    const ksid = kp.pads?.[36]?.sample?.id
    if (ksid || sid) { if (ksid === sid) return k.id; continue }
