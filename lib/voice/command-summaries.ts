...
export const COMMAND_SUMMARIES: Record<string, string> = {
  ...
  transpose: 'Moves a part up or down in semitones — twelve is an octave — or by scale degrees when you say so ("up two scale degrees"), which keeps the part in the song\'s key.',
