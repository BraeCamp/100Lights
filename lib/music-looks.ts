...
export const GENRE_LOOKS: GenreLook[] = [
  {
    ...
    bg: { pool: ['sunset-haze', 'ember-glow', 'starfield-deep', 'city-night', 'city-timelapse', 'sunset', 'nebula'], browse: 'City' },
  },
  {
    ...
    bg: { pool: ['aurora-teal', 'ocean-deep', 'waves-blue', 'mountains-dusk', 'aerial-coastline', 'beach-waves', 'aurora', 'ocean'], browse: 'Aerial' },
  },
  {
    ...
    bg: { pool: ['synthwave-grid', 'nebula-violet', 'plasma-neon', 'particles-cyan', 'bokeh-lights', 'city-night', 'city-timelapse', 'nebula', 'aurora'], browse: 'City' },
  },
  {
    ...
    bg: { pool: ['nebula-violet', 'bokeh-warm', 'liquid-magma', 'synthwave-grid', 'city-night', 'aerial-coastline', 'sunset', 'nebula'], browse: 'City' },
  },
  {
    ...
    bg: { pool: ['ember-glow', 'liquid-magma', 'synthwave-grid', 'city-timelapse', 'mountains-peaks', 'sunset', 'nebula'], browse: 'Mountains' },
  },
  {
    ...
    bg: { pool: ['ocean-deep', 'aurora-teal', 'mountains-dusk', 'starfield-deep', 'aerial-forest', 'mountains-valley', 'animals-jellyfish', 'ocean', 'forest', 'aurora'], browse: 'Mountains' },
  },
  {
    ...
    bg: { pool: ['bokeh-lights', 'bokeh-warm', 'plasma-sunset', 'particles-cyan', 'sunset-haze', 'beach-sunset', 'beach-waves', 'city-night', 'sunset', 'aurora'], browse: 'Beach' },
  },
]
