 ...
 */
// Classify a track so the preview synth can voice it right: drums as percussion,
// bass as a low punch, everything else pitched. Drums are unmistakable from the
// instrument type; bass falls back to name + register.
function classifyTrack(t, avgPitch) {
  ...
  if (/(bass|\bsub\b|808)/.test(n) || avgPitch < 48) return 'bass'
  return 'melodic'
}
