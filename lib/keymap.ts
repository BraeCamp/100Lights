...
export const KEYMAP: KeyBinding[] = [
  ...
  { id: 'notes.quantize', keys: 'Q', also: ['⌘U'], scope: 'roll', group: 'Piano Roll', action: 'Quantize the selected notes with the current settings (grid, start / end, amount)', modes: ['music'], display: 'Q or ⌘U' },
  { id: 'notes.quantizeSettings', keys: '⇧⌘U', scope: 'roll', group: 'Piano Roll', action: 'Quantize Settings — grid (straight or triplet), starts / ends / both, Amount', modes: ['music'] },
  { id: 'notes.earlier', keys: '←', scope: 'roll', group: 'Piano Roll', action: 'Nudge selected notes by the grid — with none selected, move the insert marker', modes: ['music'], display: '← / →' },
  { id: 'notes.later', keys: '→', scope: 'roll', group: 'Piano Roll', action: 'Nudge selected notes by the grid', modes: ['music'], hidden: true },
  // Keyboard-only editing (lib/caret.ts): the insert marker, a time selection, Enter between the two.
  { id: 'notes.extendLeft', keys: '⇧←', scope: 'roll', group: 'Piano Roll', action: 'Notes selected: shorten / lengthen them by the grid — none: grow a time selection from the insert marker', modes: ['music'], display: '⇧← / ⇧→' },
  { id: 'notes.extendRight', keys: '⇧→', scope: 'roll', group: 'Piano Roll', action: 'Lengthen selected notes / grow the time selection', modes: ['music'], hidden: true },
  { id: 'notes.boundaryPrev', keys: '⌥←', scope: 'roll', group: 'Piano Roll', action: 'Insert marker to the previous / next note boundary (⇧ grows the time selection there)', modes: ['music'], display: '⌥← / ⌥→' },
  { id: 'notes.boundaryNext', keys: '⌥→', scope: 'roll', group: 'Piano Roll', action: 'Insert marker to the next note boundary', modes: ['music'], hidden: true },
  { id: 'notes.extendBoundaryLeft', keys: '⇧⌥←', scope: 'roll', group: 'Piano Roll', action: 'Grow the time selection to the previous note boundary', modes: ['music'], hidden: true },
  { id: 'notes.extendBoundaryRight', keys: '⇧⌥→', scope: 'roll', group: 'Piano Roll', action: 'Grow the time selection to the next note boundary', modes: ['music'], hidden: true },
  { id: 'notes.home', keys: 'Home', scope: 'roll', group: 'Piano Roll', action: 'Insert marker to the clip start / end', modes: ['music'], display: 'Home / End' },
  { id: 'notes.end', keys: 'End', scope: 'roll', group: 'Piano Roll', action: 'Insert marker to the clip end', modes: ['music'], hidden: true },
  { id: 'notes.enter', keys: 'Enter', scope: 'roll', group: 'Piano Roll', action: 'Time selection ⇄ note selection: select the notes inside the time, or the time the notes span', modes: ['music'] },
